...
export const PROCESS = [
  ...
  },
  {
    id: "delivery",
    title: "Delivery",
    body: "Ocean or air freight, U.S. customs, and local transportation are coordinated without extra NK mark-up.",
  },
];
...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    summary:
      "Ocean and air freight, customs support, local transport, zero mark-up logistics, daily inspections, and 100% QC.",
    points: [
